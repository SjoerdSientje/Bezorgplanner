      ...
      <main className="min-h-[calc(100vh-4rem)] bg-white">
        <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
          ...
          <p className="text-koopje-black/70">
            Overzicht van de sheets: ritjes voor vandaag, planning en bezorgde
            orders.
          </p>
          ...
          <ul className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <li>
              ...
              >
                ...
                <span className="mt-1 block text-sm text-koopje-black/60">
                  Orders die vandaag gepland staan
                </span>
              </Link>
            </li>
            <li>
              ...
              >
                ...
                <span className="mt-1 block text-sm text-koopje-black/60">
                  Route en tijdsloten voor de dag
                </span>
              </Link>
            </li>
            <li>
            ...
            <li>
              ...
              >
                ...
                <span className="mt-1 block text-sm text-koopje-black/60">
                  Marktplaats-orders (bezorgd en winkel)
                </span>
              </Link>
            </li>
          </ul>
