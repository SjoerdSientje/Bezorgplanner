...
export default function VoorraadbeheerPage() {
  ...
  const opmerkingInput = (product: InventoryProductRow, className: string) => (
    <textarea
      ...
      className={`${className} min-h-[5.5rem] resize-y leading-snug`}
    ...
    <div className="mt-3 space-y-3 rounded-xl border border-stone-100 bg-stone-50/80 p-3">
      ...
      <div>
        ...
        <textarea
          ...
          className="mt-1 min-h-[5.5rem] w-full resize-y rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm leading-snug"
        />
      </div>
      <button
        type="button"
        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6">
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-4">
              <Link href="/voorraadbeheer" className="text-koopje-black/60 hover:text-koopje-black" aria-label="Terug">
                ...
                <table className="min-w-full text-left text-sm">
                  <thead className="bg-stone-50 text-xs uppercase text-stone-500">
                    <tr>
                      ...
                      <th className="min-w-[14rem] px-3 py-3">Opmerking</th>
                    ...
                    {displayedProducts.map((p) => (
                      <Fragment key={p.id}>
                        <tr className="border-t border-stone-100 hover:bg-stone-50/50">
                          ...
                          <td className="min-w-[14rem] max-w-[22rem] px-3 py-2 xl:max-w-[28rem]">
                            {opmerkingInput(
                              p,
